  ...
  return (
    <section className="container-avaliation">
      ...
      <div className="avaliation">
        <div
          className="avaliation-text"
          data-aos="flip-right"
          data-aos-duration="1500"
        >
          <p className="t1">
            &quot;Caio, conte sempre com nossa indicação! Não é atoa que só faço
            plano de saúde com você. É sempre gentil, atencioso e cuidadoso
            conosco, tenho certeza que vai colher bons frutos e alcançara suas
            metas.&quot;
          </p>
        ...
        <div className="avaliation-text2"
          ...
          data-aos-duration="1500">
          <p className="t1">
            &quot;Melhor corretor, melhor assessória, melhor em tudo que diz
            respeito a sua profissão.Pra mim você é nota mil.&quot;
          </p>
        ...
        <div className="avaliation-text"
          ...
          data-aos-duration="1500">
          <p className="t1">
            &quot;Fui indicada para fazer o plano de saúde da minha família com
            o Caio. Tenho assessória quando preciso, atendimento eficiente com o
            melhor custo benéficio. Eu sempre indico a Cael para minhas
            amigas.&quot;
          </p>
        ...
        <div className="avaliation-text2"
          ...
          data-aos-duration="1500">
          <p className="t1">
            &quot;Você é um excelente Profissional, tenho serviço
            diferenciado.Tenha certeza que sempre que alguem me procurar vou
            indicar a Cael. Parabéns pelo profissionalismo.&quot;
          </p>
