...
import image3 from '../assets/partners/sulamerica.svg'
...
const SectionOne = () => {
  ...
  return (
      ...
      <motion.h2>Conheça as operadoras parceiras da Cael Consultoria e escolha o melhor plano de saúde para você.</motion.h2>
